...
public class AdeptiaKernelStats extends AdeptiaStats {
    ...
    public Map<String, String> getStats(SimpleHttpClient httpClient, String jSessionId, AdeptiaStatsRequester adeptiaStatsRequester) throws TaskExecutionException {
        ...
        String kernelStatsString = adeptiaStatsRequester.requestStats(httpClient, jSessionId, "kernel");

        XStream xStream = new XStream();
        xStream.ignoreUnknownElements();
        xStream.processAnnotations(Monitor.class);

        Monitor kernelStats = (Monitor) xStream.fromXML(kernelStatsString);
        Map<String, String> stats = getStatsFromMonitor(kernelStats, "Kernel");
        return stats;
    }
}