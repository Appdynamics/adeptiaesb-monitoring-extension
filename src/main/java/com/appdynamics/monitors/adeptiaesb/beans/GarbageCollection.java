...
@XStreamAlias("garbage-collection")
public class GarbageCollection {
    @XStreamAlias("garbage-collector-name")
    private String garbageCollectorName;
    @XStreamAlias("garbage-collections")
    private String garbageCollections;
    @XStreamAlias("total-time-spent")
    ...
    public void setGarbageCollectorName(String garbageCollectorName) {
